...
user.org:user:wedrowiec_regs:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set rxd [ create_bd_port -dir I -type data rxd ]
...
\
  ...
  # Create instance: wedrowiec_regs_0, and set properties
  set wedrowiec_regs_0 [ create_bd_cell -type ip -vlnv user.org:user:wedrowiec_regs:1.0 wedrowiec_regs_0 ]
  ...
  # Create instance: wedrowiec_top_0, and set properties
  set block_name wedrowiec_top
  set block_cell_name wedrowiec_top_0
  if { [catch {set wedrowiec_top_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $wedrowiec_top_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins wedrowiec_regs_0/S00_AXI]
  ...
  connect_bd_intf_net -intf_net wedrowiec_top_0_wedrowiec [get_bd_intf_pins wedrowiec_regs_0/axis_wedrowiec] [get_bd_intf_pins wedrowiec_top_0/wedrowiec]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0  [get_bd_pins processing_system7_0/FCLK_CLK0] \
  [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] \
  [get_bd_pins wedrowiec_regs_0/s00_axi_aclk] \
  [get_bd_pins axi_smc/aclk] \
  [get_bd_pins wedrowiec_top_0/clk] \
  ...
  [get_bd_pins wedrowiec_regs_0/s00_axi_aresetn] \
  [get_bd_pins axi_smc/aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_reset  [get_bd_pins rst_ps7_0_100M/peripheral_reset] \
  [get_bd_pins wedrowiec_top_0/rst]
  connect_bd_net -net rxd_1  [get_bd_ports rxd] \
  [get_bd_pins wedrowiec_top_0/rxd]
  connect_bd_net -net wedrowiec_regs_0_ap_start  [get_bd_pins wedrowiec_regs_0/ap_start] \
  [get_bd_pins wedrowiec_top_0/ap_start]
  connect_bd_net -net wedrowiec_top_0_ap_done  [get_bd_pins wedrowiec_top_0/ap_done] \
  [get_bd_pins wedrowiec_regs_0/ap_done]
  connect_bd_net -net wedrowiec_top_0_ap_idle  [get_bd_pins wedrowiec_top_0/ap_idle] \
  [get_bd_pins wedrowiec_regs_0/ap_idle]
  connect_bd_net -net wedrowiec_top_0_ap_ready  [get_bd_pins wedrowiec_top_0/ap_ready] \
  [get_bd_pins wedrowiec_regs_0/ap_ready]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs wedrowiec_regs_0/S00_AXI/S00_AXI_reg] -force
