...
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
  AP_CLANG_PATH := G:/Xilinx/Vitis/2024.2/vcxx/libexec/
TOOLCHAIN += --sysroot=G:/Xilinx/Vitis/2024.2/tps/mingw/10.0.0/win64.o/nt
...
LFLAG += -lpthread
LFLAG += -L G:/Xilinx/Vitis/2024.2/vcxx/lib/clang/14.0.6/lib/windows -lclang_rt.builtins-x86_64
...
$(ObjDir)/wedrowiec_hls_test.cpp_pre.cpp.tb.o : wedrowiec_hls_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling wedrowiec_hls_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/wedrowiec_hls.cpp_pre.cpp.tb.o : wedrowiec_hls.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling wedrowiec_hls.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c -std=c++0x $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/wedrowiec_hls_axi.cpp_pre.cpp.tb.o : wedrowiec_hls_axi.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling wedrowiec_hls_axi.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c -std=c++0x $(IFLAG) $(DFLAG) $< -o $@; \
