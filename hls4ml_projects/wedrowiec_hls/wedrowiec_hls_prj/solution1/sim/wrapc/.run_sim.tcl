...
# 
# ==============================================================
set ::env(PATH) "G:/Xilinx/Vitis/2024.2/win64/tools/fpo_v7_1;$::env(Path)"
set ::env(PATH) "G:/Xilinx/Vitis/2024.2/win64/tools/fft_v9_1;$::env(Path)"
set ::env(PATH) "G:/Xilinx/Vitis/2024.2/win64/tools/fir_v7_0;$::env(Path)"
set ::env(PATH) "G:/Xilinx/Vitis/2024.2/win64/tools/dds_v6_0;$::env(Path)"
set ::env(PATH) "G:/Xilinx/Vitis/2024.2/tps/mingw/10.0.0/win64.o/nt/bin;$::env(Path)"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "wedrowiec_hls_axi.autotvin.dat"
	set constFileTvOut       "wedrowiec_hls_axi.autotvout.dat"
	set constFileHdlTvIn     "wedrowiec_hls_axi.autohdltvin.dat"
	set constFileHdlTvOut    "wedrowiec_hls_axi.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
