...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.wedrowiec_hls_axi.autotvin_in_r_V_data_V.dat"
         "c.wedrowiec_hls_axi.autotvin_in_r_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.wedrowiec_hls_axi.autotvout_out_r_V_data_V.dat"
         "rtl.wedrowiec_hls_axi.autotvout_out_r_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
