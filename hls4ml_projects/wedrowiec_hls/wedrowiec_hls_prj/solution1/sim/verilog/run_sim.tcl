...
if {[file isfile wedrowiec_hls_axi.autotvin.dat]} {
	file delete -force wedrowiec_hls_axi.autotvin.dat
}

if {[file isfile wedrowiec_hls_axi.autotvout.dat]} {
	file delete -force wedrowiec_hls_axi.autotvout.dat
}
