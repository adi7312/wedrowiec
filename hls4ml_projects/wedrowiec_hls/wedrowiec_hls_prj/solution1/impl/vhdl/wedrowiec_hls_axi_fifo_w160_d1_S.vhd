...
entity wedrowiec_hls_axi_fifo_w160_d1_S is 
    generic (
...
architecture rtl of wedrowiec_hls_axi_fifo_w160_d1_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component wedrowiec_hls_axi_fifo_w160_d1_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 160;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 1);
...
begin
----------------------- Instantiation -----------------------
    U_wedrowiec_hls_axi_fifo_w160_d1_S_ShiftReg : wedrowiec_hls_axi_fifo_w160_d1_S_ShiftReg
    generic map (
...
entity wedrowiec_hls_axi_fifo_w160_d1_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 160;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 1);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end wedrowiec_hls_axi_fifo_w160_d1_S_ShiftReg;

architecture rtl of wedrowiec_hls_axi_fifo_w160_d1_S_ShiftReg is
