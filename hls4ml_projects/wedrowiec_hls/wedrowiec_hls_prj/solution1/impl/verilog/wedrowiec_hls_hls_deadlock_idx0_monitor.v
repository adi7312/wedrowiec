...
module wedrowiec_hls_hls_deadlock_idx0_monitor ( // for module wedrowiec_hls_wedrowiec_hls_inst
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[6] = idx3_block & (1'b0 | axis_block_sigs[1]);
