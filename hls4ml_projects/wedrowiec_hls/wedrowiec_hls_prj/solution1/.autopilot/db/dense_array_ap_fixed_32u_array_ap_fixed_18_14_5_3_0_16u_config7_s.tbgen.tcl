set moduleName dense_array_ap_fixed_32u_array_ap_fixed_18_14_5_3_0_16u_config7_s
set isTopModule 0
...
set cdfgNum 18
set C_modelName {dense<array<ap_fixed,32u>,array<ap_fixed<18,14,5,3,0>,16u>,config7>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer6_out int 192 regular {fifo 0 volatile }  }
	{ layer7_out int 288 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "layer6_out", "interface" : "fifo", "bitwidth" : 192, "direction" : "READONLY"} , 
 	{ "Name" : "layer7_out", "interface" : "fifo", "bitwidth" : 288, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer7_out_din sc_out sc_lv 288 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer7_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":288, "type": "signal", "bundle":{"name": "layer7_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer6_out { ap_fifo {  { layer6_out_dout fifo_data_in 0 192 }  { layer6_out_empty_n fifo_status 0 1 }  { layer6_out_read fifo_port_we 1 1 }  { layer6_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer6_out_fifo_cap fifo_update 0 2 } } }
	layer7_out { ap_fifo {  { layer7_out_din fifo_data_in 1 288 }  { layer7_out_full_n fifo_status 0 1 }  { layer7_out_write fifo_port_we 1 1 }  { layer7_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer7_out_fifo_cap fifo_update 0 2 } } }
}
