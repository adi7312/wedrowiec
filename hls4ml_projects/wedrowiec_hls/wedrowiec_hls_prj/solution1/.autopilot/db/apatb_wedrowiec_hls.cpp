...
// wrapc file define:
#define AUTOTB_TVIN_input_layer "../tv/cdatafile/c.wedrowiec_hls.autotvin_input_layer.dat"
...
#define AUTOTB_TVOUT_layer9_out "../tv/cdatafile/c.wedrowiec_hls.autotvout_layer9_out.dat"
#define WRAPC_STREAM_SIZE_OUT_layer9_out "../tv/stream_size/stream_size_out_layer9_out.dat"
#define WRAPC_STREAM_EGRESS_STATUS_layer9_out "../tv/stream_size/stream_egress_status_layer9_out.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_layer9_out "../tv/rtldatafile/rtl.wedrowiec_hls.autotvout_layer9_out.dat"
...
extern "C"
void wedrowiec_hls_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_wedrowiec_hls_hw(void* __xlx_apatb_param_input_layer, void* __xlx_apatb_param_layer9_out)
{
  ...
  static hls::sim::Stream<hls::sim::Byte<16>> port1 {
    ...
    .name = "layer9_out",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_layer9_out),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_layer9_out),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_layer9_out),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_layer9_out),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<16>>*)__xlx_apatb_param_layer9_out;
  port1.hasWrite = true;
  ...
  try {
    ...
    wedrowiec_hls_hw_stub_wrapper(__xlx_apatb_param_input_layer, __xlx_apatb_param_layer9_out);
    port1.buffer();
