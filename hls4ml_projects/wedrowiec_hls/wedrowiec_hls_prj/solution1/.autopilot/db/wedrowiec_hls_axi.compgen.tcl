...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler wedrowiec_hls_axi_ctype_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler wedrowiec_hls_axi_fifo_w64_d8_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {in_local_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler wedrowiec_hls_axi_fifo_w100_d1_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {out_local_U}
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler wedrowiec_hls_axi_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}
