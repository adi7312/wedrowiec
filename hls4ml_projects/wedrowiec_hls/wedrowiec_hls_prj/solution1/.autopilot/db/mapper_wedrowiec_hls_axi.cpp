...
using hls::sim::Byte;
extern "C" void wedrowiec_hls_axi(volatile void *, volatile void *, volatile void *, volatile void *);
extern "C" void apatb_wedrowiec_hls_axi_hw(volatile void * __xlx_apatb_param_in_V_data_V, volatile void * __xlx_apatb_param_in_V_last_V, volatile void * __xlx_apatb_param_out_V_data_V, volatile void * __xlx_apatb_param_out_V_last_V) {
using hls::sim::createStream;
auto* sin_V_data_V = createStream((hls::stream<int>*)__xlx_apatb_param_in_V_data_V);
...
auto* sout_V_data_V = createStream((hls::stream<int>*)__xlx_apatb_param_out_V_data_V);
...
auto* sout_V_last_V = createStream((hls::stream<char>*)__xlx_apatb_param_out_V_last_V);
  // DUT call
  wedrowiec_hls_axi(sin_V_data_V->data<int>(), sin_V_last_V->data<char>(), sout_V_data_V->data<int>(), sout_V_last_V->data<char>());
sin_V_data_V->transfer((hls::stream<int>*)__xlx_apatb_param_in_V_data_V);
sin_V_last_V->transfer((hls::stream<char>*)__xlx_apatb_param_in_V_last_V);
sout_V_data_V->transfer((hls::stream<int>*)__xlx_apatb_param_out_V_data_V);
