set moduleName relu_array_ap_fixed_32u_array_ap_fixed_6_4_0_0_0_32u_relu_config6_s
set isTopModule 0
...
set cdfgNum 18
set C_modelName {relu<array<ap_fixed,32u>,array<ap_fixed<6,4,0,0,0>,32u>,relu_config6>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer5_out int 576 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "layer5_out", "interface" : "fifo", "bitwidth" : 576, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ layer5_out_dout sc_in sc_lv 576 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer5_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":576, "type": "signal", "bundle":{"name": "layer5_out", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	layer5_out { ap_fifo {  { layer5_out_dout fifo_data_in 0 576 }  { layer5_out_empty_n fifo_status 0 1 }  { layer5_out_read fifo_port_we 1 1 }  { layer5_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer5_out_fifo_cap fifo_update 0 2 } } }
	layer6_out { ap_fifo {  { layer6_out_din fifo_data_in 1 192 }  { layer6_out_full_n fifo_status 0 1 }  { layer6_out_write fifo_port_we 1 1 }  { layer6_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer6_out_fifo_cap fifo_update 0 2 } } }
}
