set moduleName dense_latency_wrapper_ap_fixed_ap_fixed_18_14_5_3_0_config7_s
set isTopModule 0
...
set cdfgNum 18
set C_modelName {dense_latency_wrapper<ap_fixed,ap_fixed<18,14,5,3,0>,config7>}
