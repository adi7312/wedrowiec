set moduleName relu_array_ap_fixed_16u_array_ap_fixed_10_4_0_0_0_16u_relu_config8_s
set isTopModule 0
...
set cdfgNum 18
set C_modelName {relu<array<ap_fixed,16u>,array<ap_fixed<10,4,0,0,0>,16u>,relu_config8>}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ layer7_out int 416 regular {fifo 0 volatile }  }
	{ layer8_out int 160 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "layer7_out", "interface" : "fifo", "bitwidth" : 416, "direction" : "READONLY"} , 
 	{ "Name" : "layer8_out", "interface" : "fifo", "bitwidth" : 160, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ layer7_out_dout sc_in sc_lv 416 signal 0 } 
	...
	{ layer8_out_din sc_out sc_lv 160 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer7_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":416, "type": "signal", "bundle":{"name": "layer7_out", "role": "dout" }} , 
 	...
 	{ "name": "layer8_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":160, "type": "signal", "bundle":{"name": "layer8_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	layer7_out { ap_fifo {  { layer7_out_dout fifo_data_in 0 416 }  { layer7_out_empty_n fifo_status 0 1 }  { layer7_out_read fifo_port_we 1 1 }  { layer7_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer7_out_fifo_cap fifo_update 0 2 } } }
	layer8_out { ap_fifo {  { layer8_out_din fifo_data_in 1 160 }  { layer8_out_full_n fifo_status 0 1 }  { layer8_out_write fifo_port_we 1 1 }  { layer8_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer8_out_fifo_cap fifo_update 0 2 } } }
}
